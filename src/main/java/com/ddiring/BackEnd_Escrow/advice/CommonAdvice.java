...
public class CommonAdvice {
    ...
    public ResponseEntity<ApiResponseDto<String>> ApplicationException(ApplicationException ex) {
        ...
        ApiResponseDto<String> body = ApiResponseDto.createError(ex.getErrorCode(), ex.getErrorMessage());
        return new ResponseEntity<>(body, ex.getStatus());
    }

    @ExceptionHandler(Exception.class)
    public ResponseEntity<ApiResponseDto<String>> ApplicationException(Exception ex) {
